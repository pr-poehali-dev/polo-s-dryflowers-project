        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center p-6 rounded-lg bg-white shadow-sm">
              ...
              <h4 className="text-xl font-semibold text-accent mb-2">Через SBP</h4>
              <p className="text-accent/70">Система быстрых платежей</p>
            </div>
            <div className="text-center p-6 rounded-lg bg-white shadow-sm">
              <Icon name="Wallet" size={48} className="text-primary mx-auto mb-4" />
              <h4 className="text-xl font-semibold text-accent mb-2">Электронные кошельки</h4>
              <p className="text-accent/70">ЮMoney, QIWI</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible>
              ...
              <AccordionItem value="payment">
                ...
                <AccordionContent className="text-accent/80">
                  Принимаем оплату банковскими картами, через СБП, электронные кошельки. 
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-accent">+7 (999) 123-45-67</span>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-accent">г. Москва, ул. Цветочная, д. 15</span>
                </div>
                <div className="flex items-center space-x-3">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <Icon name="Instagram" size={24} className="text-white/80 hover:text-secondary cursor-pointer" />
